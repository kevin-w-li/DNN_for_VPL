"""
This network trains the network while freezing successive lower layers
"""
...
# ================================
# ================================
# variying parameter, DO NOT CHANGE!
...
# setup different refisions for this feature
if train_feat == 'wave':
    ref_list = [0.01,0.03,0.1]
    #ref_list = [0.01,0.05]           # FIXME
elif train_feat == 'angle':
    ref_list = np.arange(0.0,180.0,15.0)
    #ref_list = [0.01,0.1]            # FIXME
else: raise('train_feat not valid')
...
#params = range(nlayers-4,nlayers-1,2)   #FIXME
params = range(0,nlayers,1)          #FIXME
#========================
#========================
# ref_list = [0]  # PLOT
for ref in ref_list:
    ...
    angle1 = ref if train_feat == 'angle' else 0.0
    wave_j =  ref if train_feat == 'wave'  else 0.0
    ctrst_j = 0.0
    ...
    for pi,p in enumerate(params):
        ...
        for ln, test_data_group in test_phases.iteritems():
            ...
            if ln != 'train':
                test_param['data_size'] = 1
                test_param['nfold']     = 1
                test_param['batch_size']= 1
            else:
                test_param['data_size'] = test_num
                test_param['nfold']     = nfold
                test_param['batch_size']= test_batch_size
